...
declare namespace Chart {
    ...
    interface ChartAnimationOptions {
        ...
        /**
         * @private Undocumented (used in doughnut, pie and polar area chart types)
         */
    ...
    interface ChartTooltipModel {
        ...
        /**
         * @name Body
         * @description The body lines that need to be rendered
    ...
    interface ChartDataSetsLineScatterBase {
        type: 'line' | 'scatter';
        backgroundColor?: ChartColor;
    ...
    interface ChartDataSetsDoughnut {
        type: 'doughnut' | 'pie';
        backgroundColor?: ScriptableIndexable<ChartColor>;
    ...
    interface ChartDataSetsPolarArea {
        type: 'polarArea';
        backgroundColor?: ScriptableIndexable<ChartColor>;
        borderAlign?: ScriptableIndexable<AlignType>;
        borderColor?: ScriptableIndexable<ChartColor>;
